...
class TestTafServiceServantClient implements TestTafServiceServant
{
    ...
    {
        $this->client->send($this, __FUNCTION__);
    }

    public function testLofofTags($tags, &$outtags)
    {
        list($outtags, $ret) = $this->client->send($this, __FUNCTION__, $tags);
    ...
    {
        list($outGreetings) = $this->client->send($this, __FUNCTION__, $name);
    }

    public function testBasic($a, $b, $c, &$d, &$e, &$f)
    {
        list($d, $e, $f, $ret) = $this->client->send($this, __FUNCTION__, $a, $b, $c);
    ...
    {
        list($d, $ret) = $this->client->send($this, __FUNCTION__, $a, $b);
    ...
    {
        list($d, $m2, $ret) = $this->client->send($this, __FUNCTION__, $a, $b, $m1);
    ...
    {
        list($v3, $v4, $ret) = $this->client->send($this, __FUNCTION__, $a, $v1, $v2);
    ...
    {
        list($ret) = $this->client->send($this, __FUNCTION__);
    ...
    {
        list($ocs, $ovcs, $ret) = $this->client->send($this, __FUNCTION__, $cs, $vcs);
    ...
    {
        list($omcs, $ret) = $this->client->send($this, __FUNCTION__, $mcs);
    ...
    {
        list($b1, $in2, $d, $v3, $v4, $ret) = $this->client->send($this, __FUNCTION__, $a);
